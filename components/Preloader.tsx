...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            <div className="preloader-item h-full w-[10%] bg-white opacity-85"></div>
            <div className="preloader-item h-full w-[10%] bg-white opacity-85"></div>
            <div className="preloader-item h-full w-[10%] bg-white opacity-85"></div>
            <div className="preloader-item h-full w-[10%] bg-white opacity-85"></div>
            <div className="preloader-item h-full w-[10%] bg-white opacity-85"></div>
            ...
            <p className="name-text flex text-[20vw] lg:text-[200px] text-gray-500 font-anton text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden">
